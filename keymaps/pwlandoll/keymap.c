 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  |      | LGUI | LAlt | Lower| Enter| Space| Raise| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    KC_ESC,  KC_NO,   KC_LGUI, KC_LALT, MO(_LOWER), KC_ENT,   KC_SPC,   MO(_RAISE), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
